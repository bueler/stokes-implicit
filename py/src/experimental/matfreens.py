# see https://www.firedrakeproject.org/demos/navier_stokes.py.html
...
print('Newton with direct solve (MUMPS LU) using assembled matrix ...')
try:
...
print('Newton with matrix-free FGMRES+Schur with assembled velocity block and LU ...')
up.assign(0)
