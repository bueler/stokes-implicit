...
Now, the use of thin-layer (shallow) approximations for modeling glaciers and ice sheets is well-established \cite{SchoofHewitt2013}, and the simplest of these models is the SIA.  It is appropriate to our grounded, non-sliding context.  Following Chapter 18 in \cite{Fowler1997}, we summarize the small-parameter argument which leads to the SIA strong form, and then convert it to a weak form with maximum analogy to \eqref{weakdecoupled} above.
