...
FIXME describe top boundary conditions; Figure \ref{fig:claplaceproblem} shows boundary conditions on $\Lambda$

\begin{figure}[h]
\begin{center}
\includegraphics[width=0.75\textwidth]{figs/claplaceproblem.pdf}
\end{center}
\caption{A sketch of problem \eqref{claplace}.  See text regarding the shading.}
