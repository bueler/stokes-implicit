...
\end{equation}
Functions $j,\ell$ will appear in the next section as coefficients in integrals over $\Lambda$; because of regularization \eqref{definejell} these integrals will be finite.  Specifically, formulas \eqref{changediv} and \eqref{changeDu} will be used in the coupled weak form in the next section.
...
From weak forms \eqref{definetildeF} and FIXME, the proposed [DRAFT] weak form is
\begin{align}
